...
const DBConfiguration = __importStar(require("./db"));
const StoreOptions = {
...
mongoose_1.default.connect((DBConfiguration.RemoteURI) ? DBConfiguration.RemoteURI : DBConfiguration.LocalURI);
...
app.use('/authentication', user_1.default);
